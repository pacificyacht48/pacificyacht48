export const translations = {
  en: {
    ...
    hero: { subtitle: 'Experience the Extraordinary', title1: 'Beyond', title2: 'Boundaries' },
  ...
  de: {
    ...
    hero: { subtitle: 'Erleben Sie das Außergewöhnliche', title1: 'Jenseits der', title2: 'Grenzen' },
  ...
  ru: {
    ...
    hero: { subtitle: 'Испытайте необыкновенное', title1: 'За', title2: 'Пределами' },
  ...
  ar: {
    ...
    hero: { subtitle: 'جرب الاستثنائي', title1: 'وراء', title2: 'الحدود' },
