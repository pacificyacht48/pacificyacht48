...
import { Calendar as CalendarIcon, Anchor, Compass, Ship, MapPin, Search, Menu, X, Facebook, Instagram, Twitter } from 'lucide-react';
    ...
    <div dir={isRtl ? 'rtl' : 'ltr'} className="min-h-screen bg-[#F5F2ED] text-[#0A192F] font-sans selection:bg-[#D4AF37] selection:text-white">
            ...
            {(dynamicBoats.length > 0 ? dynamicBoats : featuredYachts).map((yacht, index) => (
              ...
              >
                <div className="relative h-80 md:h-96 overflow-hidden mb-6">
                  ...
                  />
                  <div className={`absolute top-4 ${isRtl ? 'right-4' : 'left-4'} bg-[#0A192F]/80 backdrop-blur-sm px-4 py-2 text-xs uppercase tracking-widest border border-[#D4AF37]/30`}>
      ...
      <footer className="bg-[#020C1B] text-white pt-20 pb-10 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-2xl font-serif tracking-widest uppercase">Pacific Yachting</span>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <a href="#" className="w-10 h-10 rounded-full border border-gray-700 flex items-center justify-center hover:border-[#D4AF37] hover:text-[#D4AF37] transition-colors"><Instagram className="w-4 h-4" /></a>
              <a href="#" className="w-10 h-10 rounded-full border border-gray-700 flex items-center justify-center hover:border-[#D4AF37] hover:text-[#D4AF37] transition-colors"><Twitter className="w-4 h-4" /></a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li dir="ltr" className={isRtl ? 'text-right' : ''}>info@pacificyachting.com</li>
              <li dir="ltr" className={isRtl ? 'text-right' : ''}>+1 (800) 123-4567</li>
              <li>Marina Bay, Suite 100<br/>Luxury Coast, LC 90210</li>
            </ul>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
          <p>&copy; {new Date().getFullYear()} Pacific Yachting. {t.footer.rights}</p>
